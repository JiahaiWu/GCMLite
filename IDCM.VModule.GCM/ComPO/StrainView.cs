...
namespace IDCM.ComPO
{
    class StrainView
    {
        ...
        public Starin_passport strain_passport { get; set; }
        /// <summary>
        ...
        public Dictionary<string, object> ToDictionary()
        {
            ...
            dict.Add("starin_passport", strain_passport);
            return dict;
        }
        /// <summary>
        ...
        public Dictionary<string, string> getPalinKVPairs()
        {
            ...
            if (strain_passport != null)
                foreach (KeyValuePair<string, dynamic> entry in strain_passport)
                {
                    dict[entry.Key] = Convert.ToString(entry.Value);
                }
            return dict;
